...
## 18.4 Explicit Non-Goals (EBLG v1)

Peninsula v1 is not intended to:

- Replace core practice-management, billing, or trust-accounting systems
- Bypass existing systems-of-record for legal operations
- Auto-publish legal work product without human review
- Introduce broad full-mailbox ingestion without matter-level policy controls
...
## 22.1 NetDocs + Peninsula Operating Pattern

Recommended architecture for EBLG:

| System | Primary role |
| --- | --- |
| NetDocs / DMS | canonical document management and matter attachment |
| Enterprise system (CRM/time/billing) | operational and financial system-of-record |
| Peninsula + Kelso | firm-wide knowledge graph, retrieval, analysis, and work-product acceleration |

Operating pattern:

1. NetDocs and enterprise systems feed Peninsula through approved connectors.
2. Peninsula structures this data and preserves provenance to source systems.
3. Team uses natural language in Peninsula for deep retrieval and synthesis.
4. Final document control can remain in NetDocs according to firm policy.

This preserves existing staff workflows while adding AI-native knowledge leverage.
