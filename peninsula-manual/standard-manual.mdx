...
This is not a UI feature guide. It is an architecture, policy, and operating specification intended to support governance, engineering implementation, and future diligence review.
